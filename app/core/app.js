...
.config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$resourceProvider', '$httpProvider',
	function($stateProvider, $urlRouterProvider, $locationProvider, $resourceProvider, $httpProvider) {
		...
		$stateProvider
			...
			.state('app.section1',             {url:'section1',     templateUrl: '../app/components/section/section.html'                                ,controller : 'appSection'              ,resolve: {sValue: function() {return {section : "section1", enter:"horizontal", leave:"horizontal"};}}})
			.state('app.section2',             {url:'section2',     templateUrl: '../app/components/section/sectionWithSubSection.html', abstract: true  ,controller : function($scope) {$scope.state="section2";$scope.enter="horizontal";$scope.leave="horizontal";}                                              ,params : { haveSubSection : true}})
			.state('app.section2.subsection1', {url:'/subsection1', templateUrl: '../app/components/section/subSection.html'                             ,controller : 'appSubSection'           ,resolve: {sValue: function() {return {section : "section2.subsection1", enter:"vertical", leave:"vertical"};}}    ,params : { subsection : 1 , parentName : "section2"}})
			.state('app.section2.subsection2', {url:'/subsection2', templateUrl: '../app/components/section/subSection.html'                             ,controller : 'appSubSection'           ,resolve: {sValue: function() {return {section : "section2.subsection2", enter:"vertical", leave:"vertical"};}}    ,params : { subsection : 2 , parentName : "section2"}})
			.state('app.section3',             {url:'section3',     templateUrl: '../app/components/section/section.html'                                ,controller : 'appSection'              ,resolve: {sValue: function() {return {section : "section3", enter:"horizontal", leave:"horizontal"};}}})
			.state('app.section4',             {url:'section4',     templateUrl: '../app/components/section/section.html'                                ,controller : 'appSection'              ,resolve: {sValue: function() {return {section : "section4", enter:"horizontal", leave:"horizontal"};}}});
